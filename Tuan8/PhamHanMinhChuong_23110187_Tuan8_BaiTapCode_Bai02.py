...
def hoan_doi_random(bang):
    ...
    for r in range(N):
        if r != b[c]:  
            ...
            temp_b[c] = r # di chuyển hậu vào vị trí giả định -> để kiểm tra số xd có nhỏ hơn trước đó k ? 
...
def SA():
    ...
    def run_step():
      ...
      # nếu ít xd hơn -> <0 hoặc random xác suất chấp nhận theo số thực 
...
#______________________GIAO DIEN______________________________
